...
. Wählen Sie das Aktionsmenü für das Volume mit dem Snapshot aus, das bearbeitet werden soll.
...
. Wählen Sie das Menü aus image:workloads-menu-icon.png["Über das Hamburger-Menüsymbol kann man zu Workloads wie Speicher, EDA, KI, Datenbanken, VMware und Administration navigieren."] und wählen Sie dann *Speicher* aus.
. Im Menü „Speicher“ die Option *Volumes explorer* auswählen.
. Wählen Sie das Aktionsmenü für das Volume mit dem Snapshot aus, auf das zugegriffen werden soll.
. Wählen Sie *Datenschutzaktionen* und dann *Snapshots verwalten*.
...
. Wählen Sie das Menü aus image:workloads-menu-icon.png["Über das Hamburger-Menüsymbol kann man zu Workloads wie Speicher, EDA, KI, Datenbanken, VMware und Administration navigieren."] und wählen Sie dann *Speicher* aus.
. Im Menü „Speicher“ die Option *Volumes explorer* auswählen.
. Wählen Sie das Aktionsmenü für das Volume mit dem zu löschenden Snapshot aus.
. Wählen Sie *Datenschutzaktionen* und dann *Snapshots verwalten*.
