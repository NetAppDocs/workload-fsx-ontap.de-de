...
.. *S3-Endpunkt*: Fügen Sie optional einen S3-Endpunkt hinzu, um über AWS S3-APIs auf FSx für ONTAP -Dateisystemdaten zuzugreifen, die sich auf NFS- oder SMB/CIFS-Volumes befinden.  Es wird nur der Dateizugriffstyp unterstützt.  Geben Sie die folgenden Details an:
+
*** *S3-Endpunktname*: Geben Sie den Namen des S3-Endpunkts ein.
