...
* Operative Exzellenz: Automatisches Kapazitätsmanagement, Schwellenwert für die Auslastung der Volume-Dateikapazität, nahezu vollständige Volume-Auslastung und Schreibmodus für Cache-Beziehungen
* Kostenoptimierung: Speichereffizienz, Daten-Tiering, unnötiges Löschen von Snapshots und Backups
