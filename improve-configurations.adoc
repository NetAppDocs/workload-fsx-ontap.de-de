...
* Sicherheit: NetApp Autonomous Ransomware Protection mit KI (ARP/AI)
* Operative Exzellenz: Speichereffizienz, automatisches Kapazitätsmanagement und Schwellenwert für die Kapazitätsauslastung von Volume-Dateien
