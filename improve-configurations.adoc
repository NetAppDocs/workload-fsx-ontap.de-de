...
* Zuverlässigkeit: SSD-Kapazitätsschwelle, geplante lokale Snapshots, geplante Volume-Backups, Remote-Datenreplizierung, Datenzuverlässigkeit für die langfristige Aufbewahrung und Verbindung von Hosts mit dem Failover-Knoten
...
* Kostenoptimierung: Speichereffizienzen, Daten-Tiering, unnötiges Löschen von Snapshots und Backups, inaktive Blockgeräte, ungenutzte SSD-Kapazität und inaktive NAS-Volumes
* Leistungseffizienz: Hosts mit bevorzugtem Node verbinden
