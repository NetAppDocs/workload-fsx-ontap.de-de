...
* Stellen Sie sicher, dass die TCP-Ports 11104 und 11105 geöffnet sind, um sicheren Datentransfer und Verwaltung zwischen den Speichersystemen zu ermöglichen.
