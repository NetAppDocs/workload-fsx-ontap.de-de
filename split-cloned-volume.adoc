...
. Wählen Sie auf der Registerkarte *FSX für ONTAP* das drei Punkte-Menü des FSX für ONTAP-Dateisystems aus, das das geklonte Volume enthält, das geteilt werden soll, und wählen Sie dann *Verwalten* aus.
