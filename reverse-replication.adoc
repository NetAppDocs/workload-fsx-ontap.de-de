...
---
= Umkehren einer Replikationsbeziehung in NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Kehren Sie eine Replikationsbeziehung in NetApp Workload Factory um, sodass das Zielvolume zum Quellvolume wird.
