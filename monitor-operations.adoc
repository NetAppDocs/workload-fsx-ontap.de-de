...
summary: Verfolgen Sie FSx für ONTAP, Anmeldeinformationen und Linkvorgänge und überwachen Sie den Jobfortschritt mit Tracker in NetApp Workload Factory für Storage. 
---
= Überwachen Sie Speichervorgänge mit Tracker in NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
