...
. Wählen Sie in *FSx for ONTAP* das Aktionsmenü des Dateisystems und anschließend *Verwalten*.
. Wählen Sie in der Dateisystemübersicht unter „Speicher-VMs“ die Option „Speicher-VM erstellen“.
. Geben Sie auf der Seite „Speicher-VM erstellen“ unter „Speicher-VM-Konfiguration“ Folgendes an:
+
