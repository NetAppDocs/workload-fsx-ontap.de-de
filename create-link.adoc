...
* Sie müssen mindestens ein FSx für ONTAP Dateisystem in Workload Factory haben.  Um FSx for ONTAP Dateisysteme zu erkennen oder zu erstellen, benötigen Sie ein AWS-Konto mit Berechtigungen für FSx for ONTAP Instanzen undlink:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html#overview["Anmeldeinformationen in Workload Factory hinzufügen"^] mit _Nur-Lese_- oder _Lese-/Schreib_-Berechtigungen für die Speicherverwaltung.
