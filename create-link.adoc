...
+
Beachten Sie, dass Lambda beim Starten der CloudFormation-Vorlage drei Berechtigungen erteilt werden. Workload Factory verwendet diese Berechtigungen bei der Verwendung von Links.
