...
summary: Die Verwaltung der SMB/CIFS-Freigabe eines Volumes in Workload Factory umfasst das Erstellen, Bestimmen des Benutzer- und Gruppenzugriffs sowie das Löschen. 
---
= Verwalten der SMB/CIFS-Freigabe für ein Volume in Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
