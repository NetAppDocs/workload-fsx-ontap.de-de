...
. Wählen Sie das Aktionsmenü für das Volume, das Sie verwenden möchten, dann *Erweiterte Aktionen* und anschließend *S3-Zugriffspunkte verwalten*.
