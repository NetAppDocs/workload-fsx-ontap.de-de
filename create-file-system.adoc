...
* Anmeldeinformationen mit Berechtigungen zum Erstellen und Löschen von Dateisystemen, um ein FSx for ONTAP Dateisystem zu erstellen. link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Erfahren Sie, wie Sie einem AWS-Konto Berechtigungen erteilen"^].
...
. Wählen Sie im Speicher-Dashboard die Option *Dateisystem erstellen*.
