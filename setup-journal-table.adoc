...
* Stellen Sie die Netzwerkkonfiguration für den S3-Zugangspunkt auf *Internet* ein. link:edit-s3-access-points.html["Netzwerkkonfiguration für den S3-Zugangspunkt bearbeiten"].
...
Sollte einer der Schritte fehlschlagen, <<Beheben Sie Probleme bei der Infrastruktureinrichtung für die Journaltabelle,Fehlerbehebung bei der Infrastruktureinrichtung für die Journaltabelle>> oder wenden Sie sich an den NetApp Support, um Hilfe zu erhalten.
